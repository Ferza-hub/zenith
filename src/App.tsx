      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
            ...
            {activeProduct && !isGenerating ? (
              <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="space-y-6 mb-8 bg-gray-50 rounded-2xl p-6 border border-gray-100">
                      <div>
                        <label className="flex justify-between text-xs font-black uppercase tracking-widest mb-2">
                          ...
                          <span className="flex items-center gap-2">
                            ...
                            <span className="text-gray-900">{Math.round(liveMomentum)}%</span>
                          </span>
                        </label>
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${liveMomentum}%`,
                              backgroundColor: liveMomentum > 70 ? '#22c55e' : liveMomentum > 45 ? '#facc15' : '#ef4444'
                            }}
                          />
                        </div>
                      </div>
                      <div>
                        <label className="flex justify-between text-xs font-black uppercase tracking-widest mb-2">
                          <span className="text-gray-500">Competition Gap</span>
                          <span className="text-gray-900">{Math.round(activeProduct.competitionGap || 0)}%</span>
                        </label>
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-blue-500 rounded-full"
                            style={{ width: `${activeProduct.competitionGap || 0}%` }}
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div className="w-full md:w-96 flex flex-col gap-6">
                    ...
                    <div className="h-[280px] w-full relative -ml-2 -mt-4">
                      <ResponsiveContainer width="100%" height="100%">
                        <RadarChart cx="50%" cy="50%" outerRadius="70%" data={radarData}>
                          ...
                          <Radar name="Product" dataKey="A" stroke="#000" fill="#000" fillOpacity={0.2} />
                        </RadarChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
                  ...
                  {/* Donate Banner */}
                  <div className="bg-rose-50 border border-rose-100 rounded-2xl px-5 py-4 flex items-center justify-between gap-3">
                    <p className="text-xs text-rose-700 font-medium leading-snug">
                      Zenith is free & built by one person. If it helped, any support means a lot.
                    </p>
                    <button
                      onClick={() => window.open(donateUrl, '_blank')}
                      className="shrink-0 flex items-center gap-1.5 bg-rose-500 hover:bg-rose-600 text-white text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-xl transition-colors"
                    >
        ...
        {viewMode === 'table' && (
          <div className="relative border border-gray-100 shadow-sm rounded-2xl overflow-hidden bg-white">
            ...
            {/* Donate footer in table view */}
            <div className="border-t border-gray-100 px-6 py-4 flex items-center justify-between bg-rose-50/50">
              <p className="text-xs text-rose-600 font-medium">
                Zenith is free. Built by one person with 3 kids. If it helped you find a winning product, consider supporting.
              </p>
              <button
                onClick={() => window.open(donateUrl, '_blank')}
                className="shrink-0 ml-4 flex items-center gap-1.5 bg-rose-500 hover:bg-rose-600 text-white text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-xl transition-colors"
              >
                <Heart className="w-3 h-3" /> Support
              </button>
            </div>
